...
DROP TABLE product_toy CASCADE CONSTRAINTS;

CREATE TABLE product_toy(
		p_no                          		NUMBER(10)		 NULL ,
...
DROP SEQUENCE product_toy_p_no_SEQ;

CREATE SEQUENCE product_toy_p_no_SEQ NOMAXVALUE NOCACHE NOORDER NOCYCLE;
...
ALTER TABLE product_toy ADD CONSTRAINT IDX_product_toy_PK PRIMARY KEY (p_no);
...
ALTER TABLE cart ADD CONSTRAINT IDX_cart_FK1 FOREIGN KEY (p_no) REFERENCES product_toy (p_no);
...
ALTER TABLE order_item ADD CONSTRAINT IDX_order_item_FK1 FOREIGN KEY (p_no) REFERENCES product_toy (p_no);
