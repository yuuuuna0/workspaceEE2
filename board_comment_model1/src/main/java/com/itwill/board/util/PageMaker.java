...
public class PageMaker {
	...
	public PageMaker(int count, int curPage) {
		...
		System.out.println(this.curPage+" 페이지("+pageBegin+" ~ "+pageBegin+")");
		...
		System.out.println("04.전체게시물수					(count)		  	   "+this.totCount);
		System.out.println("05.전체페이지수					(totPage)     		57");
		System.out.println("06.현재(요청)페이지블록번호		(curBlock)    		 1");
		System.out.println("07.현재(요청)페이지블록시작번호	(blockBegin)  		 1");
		System.out.println("08.현재(요청)페이지블록끝번호	(blockEnd)    		10");
		System.out.println("09.이전블록시작페이지번호		(prevGroupStartPage) 0");
		System.out.println("10.다음블록시작페이지번호		(nextGroupStartPage)11");
		System.out.println("11.이전페이지번호				(prevPage)           7");
		System.out.println("12.다음페이지번호				(nextPage)           9");
		System.out.println("13.DB에서select할게시물시작번호	(pageBegin)         71");
		System.out.println("14.DB에서select할게시물끝번호	(pageEnd)           80");
		System.out.println("*************************************************************");
