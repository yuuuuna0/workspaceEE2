											...
											<table>
												...
												<td style="border: 1px solid; width: 50px;font-size:1pt;padding:3px"><%=bcomment.getWriter()%><br />
												 ...
												 --%>
													...
													<img style="vertical-align:top" width="20px" height="23px" src='image/guest.png'>
													<p style="display: inline-block;margin: 0px;padding: 0px"><%=bcomment.getWriter()%><br><%=bcomment.getRegDate()%></p></td> 		
													<td style="width: 400px; padding-left: 5px; margin: 0px;font-size:1pt;"><%=bcomment.getContent().replace("\r\n", "<br />")%>
													</td>

													<td style="width: 40px">
														<input type="button" value="수정" onclick="toggleCommentStatus(<%=bcomment.getCommentNo()%>, true);" />
												...
												<tr>
													...
													<td style="width: 400px; padding: 0px; margin: 0px;font-size:1pt;">
														<form id="commenteditform<%=bcomment.getCommentNo()%>"
															action="board_comment_update_action.jsp" method="post"
															...
															<textarea name="content" rows="2"
																style="width: 400px; padding: 0px; margin: 0px;font-size:1pt;"><%=bcomment.getContent()%></textarea>
														</form>
													</td>
													<td style="width: 40px"><input type="button"
														...
														onclick="toggleCommentStatus(<%=bcomment.getCommentNo()%>, false);" /></td>
												</tr>
											</table>
